...
cal_form.addEventListener("submit", function (e) {
    ...
    if (parent_check.checked && widow_check.checked && sons_check.checked && daughters_check.checked) {
        ...
        //Widow Share:
        let WidowShare = remainingAmount * 1 / 8;
        ...
        console.log(`Widows Share For each`, WidowShareForEach)
    ...
    No.of Wife : ${widowsValue}
    Parents share (total) : ${parentsShare}
    Parents share for each : ${parentsShareForEach}
    Wife share (total) : ${WidowShare}
    Wife share for each : ${WidowShareForEach}
    ${br.innerHTML}
    ...
    Wife share for each : ${WidowShareForEach}
    ${br.innerHTML}
    Remaining Property will equally distribute amoung Siblings : ${grossTotal}
    `;
    }
    ...
    widows share (total) : ${WidowShare}
    widows share for each : ${WidowShareForEach}
    ${br.innerHTML}
    Remaining worth is : ${grossTotal}
...
//Calculations----------->
    ...
    Wife share for each : ${WidowShareForEach}
    ${br.innerHTML}
    Remaining Property will equally distributed 
    amoung Siblings : ${grossTotal}
    `;
    }
